...
def update_Sk():
    ...
    folder1 = f"{epyc01}/Fore_aft_QS/Offset_MPI/L120"
    folder2 = f"{epyc02}/Fore_aft_QS/Offset_MPI/L120"

    fgsds = glob.glob(f"{folder2}/*.gsd")
    dx = 0.25
    f_cg = []
    for fgsd in fgsds:
...
if __name__ == "__main__":
    ...
    # f_snaps = [f"{folder}/L120_120_Dr3.000_Dt0.000_r40_p10_e3.000_E0.500_h0.050_1000.npz",
    #            f"{folder}/L120_120_Dr2.300_Dt0.000_r80_p20_e3.000_E0.500_h0.050_1000.npz",
    #            f"{folder}/L120_120_Dr1.500_Dt0.000_r80_p20_e3.000_E0.500_h0.050_1000.npz"
    #            ]
